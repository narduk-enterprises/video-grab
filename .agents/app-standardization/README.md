...
> **Temporary folder.** Delete when all apps are standardized: `rm -rf .agents/app-standardization/`
...
- `/check-standardization` — Verify an app meets all standardization requirements
